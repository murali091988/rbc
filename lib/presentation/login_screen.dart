    ...
    return Scaffold(
      ...
      body: SafeArea(
        ...
        child: loadingBallAppear
            ? Container(
             //   child: MessagesScreen(LoginResponse: LoginReponse!))
                 child: BottomNavigationBarExample(LoginReponse.name,LoginReponse.userType))
            : Padding(
                        ...
                        child: Column(
                          children: [
                            ...
                            GetStartedButton(
                              ...
                              onTap: () async {
                                LoginReponse = await Auth().signIn(emailController.text, passwordController.text);
                                print(LoginReponse.name);

                                if(LoginReponse.name != null){
                                  setState(() {
                                    _elementsOpacity = 0;
                                  });
                                 }
